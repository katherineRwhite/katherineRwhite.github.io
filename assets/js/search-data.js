...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "projects",
          description: "Research projects at the intersection of environmental health, housing equity, and climate change.",
          section: "Navigation",
          handler: () => {
          ...
          title: "cv",
          description: "My academic CV is available to download above. This page provides an overview of my education, research experience, publications, and service.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-presented-at-the-sfu-friesen-conference-climate-change-in-an-aging-world-on-climate-justice-approaches-to-urban-heat-and-aging-panel-watch-the-recording",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6B%61%74%68%65%72%69%6E%65.%72.%77%68%69%74%65@%75%62%63.%63%61", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/katherineRwhite", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=z4bC0V0AAAAJ", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
